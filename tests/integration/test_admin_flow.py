...
class TestListOrganizations:
    ...
    def test_superadmin_can_list_organizations(
        ...
        if isinstance(data, dict):
            items = data.get("items") or data.get("data") or data.get("organizations", [])
    ...
    def test_owner_cannot_list_organizations(
        ...
        resp = http_client.get(
            "/api/v1/admin/organizations", headers=owner_headers
        )
    ...
    def test_employee_cannot_list_organizations(
        ...
        resp = http_client.get(
            "/api/v1/admin/organizations", headers=employee_headers
        )
        assert resp.status_code == 403
...
class TestOrganizationCRUD:
    ...
    @pytest.mark.xfail(reason="DELETE /admin/organizations not yet implemented")
...
class TestOrganizationSuspension:
    ...
    def test_suspend_and_unsuspend_organization(
        ...
        assert org_data.get("is_active") is False or org_data.get("suspended") is True
...
class TestAuditLogs:
    ...
    def test_superadmin_can_list_audit_logs(
        ...
        resp = http_client.get(
            "/api/v1/admin/audit-logs", headers=superadmin_headers
        )
        assert resp.status_code == 200
    ...
    def test_owner_cannot_access_audit_logs(
        ...
        resp = http_client.get(
            "/api/v1/admin/audit-logs", headers=owner_headers
        )
        assert resp.status_code == 403
...
class TestPlatformSettings:
    ...
    def test_owner_cannot_access_settings(
        ...
        resp = http_client.get(
            "/api/v1/admin/settings", headers=owner_headers
        )
        assert resp.status_code == 403
...
class TestCrossTenantUsers:
    ...
    def test_superadmin_can_list_all_users(
        ...
        resp = http_client.get(
            "/api/v1/admin/users", headers=superadmin_headers
        )
        assert resp.status_code == 200
        data = resp.json()
        if isinstance(data, dict):
