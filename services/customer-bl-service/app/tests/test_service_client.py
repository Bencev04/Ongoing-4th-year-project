...
class TestFieldTranslation:
    def test_to_db_payload_combines_names(self):
        ...
        result = _to_db_payload({"first_name": "Alice", "last_name": "Smith", "email": "a@b.com"})
...
class TestCreateCustomer:
    ...
    @pytest.mark.asyncio
    @patch(f"{_CUST_CLIENT}.post", new_callable=AsyncMock, side_effect=httpx.ConnectError("down"))
...
class TestUpdateCustomer:
    ...
    @pytest.mark.asyncio
    @patch(f"{_CUST_CLIENT}.put", new_callable=AsyncMock, side_effect=httpx.ConnectError("down"))
...
class TestDeleteCustomer:
    ...
    @pytest.mark.asyncio
    @patch(f"{_CUST_CLIENT}.delete", new_callable=AsyncMock, side_effect=httpx.ConnectError("down"))
