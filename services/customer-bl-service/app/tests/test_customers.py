...
class TestListCustomers:
    ...
    def test_list_scoped_to_tenant(
        ...
        mock_get.return_value = {
            "items": [], "total": 0, "page": 1, "per_page": 100, "pages": 0,
        }
...
class TestGetCustomer:
    ...
    def test_get_customer_wrong_tenant(
        ...
        mock_cust.return_value = {
            "id": 99, "first_name": "X", "last_name": "Y",
            "owner_id": 999, "is_active": True,
...
class TestDeleteCustomer:
    ...
    def test_employee_cannot_delete(
        self, mock_get: AsyncMock, employee_client: TestClient, sample_customer: dict,
    ) -> None:
        mock_get.return_value = sample_customer
