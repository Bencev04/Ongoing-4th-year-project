...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql://postgres:postgres@localhost:5432/workflow_platform"
    test_database_url: str = "postgresql://postgres:postgres@localhost:5432/workflow_platform_test"
