...
async def create_organization(
    ...
    **Superadmin only.**  Writes an audit log entry on success.
    ...
    await service_client.create_audit_log({
        ...
        "details": {"name": body.name, "slug": body.slug, "plan": body.billing_plan},
    })
...
async def suspend_organization(
    ...
    **Superadmin only.**
    ...
    """
    await service_client.update_organization(org_id, {
        "is_active": False,
...
async def list_audit_logs(
    ...
    organization_id: Optional[int] = Query(None, description="Filter by org"),
