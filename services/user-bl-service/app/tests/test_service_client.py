...
class TestGetUsers:
    ...
    @pytest.mark.asyncio
    @patch(_CACHE_GET, new_callable=AsyncMock, return_value=None)
    @patch(f"{_CLIENT}.get", new_callable=AsyncMock, side_effect=httpx.ConnectError("down"))
...
class TestCreateUser:
    ...
    @pytest.mark.asyncio
    @patch(f"{_CLIENT}.post", new_callable=AsyncMock, side_effect=httpx.ConnectError("down"))
...
class TestUpdateUser:
    ...
    @pytest.mark.asyncio
    @patch(f"{_CLIENT}.put", new_callable=AsyncMock, side_effect=httpx.ConnectError("down"))
...
class TestDeleteUser:
    ...
    @pytest.mark.asyncio
    @patch(f"{_CLIENT}.delete", new_callable=AsyncMock, side_effect=httpx.ConnectError("down"))
