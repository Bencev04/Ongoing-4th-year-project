...
output "cluster_endpoint" {
  description = "Staging EKS API server URL"
  value       = module.eks.cluster_endpoint
}

output "cluster_ca_certificate" {
  description = "Staging EKS CA cert (base64)"
  value       = module.eks.cluster_ca_certificate
  sensitive   = true
}

output "node_group_name" {
  description = "Staging node group name"
...
output "loki_bucket_name" {
  description = "S3 bucket name used by staging Loki object storage"
  value       = module.observability.loki_bucket_name
}

output "loki_bucket_arn" {
  description = "S3 bucket ARN used by staging Loki object storage"
  value       = module.observability.loki_bucket_arn
}

output "loki_kms_key_arn" {
  description = "KMS key ARN used by staging Loki object storage encryption"
  value       = module.observability.loki_kms_key_arn
}

output "loki_role_arn" {
  description = "IAM role ARN for staging Loki S3 access"
  value       = module.iam.loki_role_arn
}

output "observability_alert_topic_arn" {
  description = "SNS topic ARN used by staging observability alarms"
