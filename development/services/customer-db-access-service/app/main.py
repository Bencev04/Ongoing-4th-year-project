...
Main application module that configures and starts the Customer service.
"""
...
configure_logging(
    service_name="customer-db-access-service",
...
app = FastAPI(
    ...
    description="Database access layer for customers and notes",
    version=os.environ.get("SERVICE_VERSION", "1.0.0"),
...
app.add_middleware(PrometheusMiddleware, service_name="customer-db-access-service")
...
async def startup_event() -> None:
    """Application startup handler. Schema managed by Alembic."""
    print("Customer Service started successfully")
...
async def health() -> dict:
    ...
    return {"status": "healthy", "service": "customer-db-access-service"}
