...
class TestListCustomers:
    ...
    def test_list_customers_requires_auth(self, http_client: httpx.Client) -> None:
        """
...
class TestCustomerSearch:
    ...
    def test_search_returns_matching_customers(
        ...
        if isinstance(data, dict):
            items = data.get("items") or data.get("data") or data.get("customers", [])
            assert isinstance(items, list)
        else:
            assert isinstance(data, list)

    def test_search_requires_auth(self, http_client: httpx.Client) -> None:
        """
